...
green_threshold   = (   0,   80,  -70,   -10,   -0,   30)#(20, 38, -37, -4, 3, 32)
black_threshold   = (34, 72, 2, 22, 10, 34)#（0, 13, -128, 127, -128, 127）
thresholds=(80,255)
blob_thresholds=(0,80)
...
sensor.reset() # 初始化摄像头
sensor.set_pixformat(sensor.RGB565) # 格式为 RGB565.GRAYSCALE
